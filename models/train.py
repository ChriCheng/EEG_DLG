...
# ----------------------------
# 4) Minimal runnable demo (replace dataloader with your real one)
# ----------------------------
class DummyDataset(torch.utils.data.Dataset):
    def __init__(self, n: int, n_channels: int, n_times: int, n_task_classes: int, n_users: int):
        super().__init__()
        self.x = torch.randn(n, n_channels, n_times)
        self.y_task = torch.randint(0, n_task_classes, (n,))
        self.y_user = torch.randint(0, n_users, (n,))
...
def main():
    ...
    ds = DummyDataset(n=256, n_channels=n_channels, n_times=n_times, n_task_classes=n_task_classes, n_users=n_users)
