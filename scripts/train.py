...
from models.EEGNet import EEGNetConfig, EEGNetMI1MI2, LMEEGNetConfig, LMEEGNetMI1MI2
...
# =========================
# 4) Stage 2: train user classifier on fixed task backbone
# =========================
...
def reset_user_head_from_fresh_model(
    model: nn.Module,
    ds: Dataset,
    *,
    user_hidden_dim: int,
...
def main():
    ...
    for seed in seeds:
        ...
        for train_session_internal in range(ds.n_sessions):
            ...
            reset_user_head_from_fresh_model(
                model,
                ds,
                user_hidden_dim=args.user_hidden_dim,
                model_name=args.model,
